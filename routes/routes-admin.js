...
router.get('/api/admin/usuarios/protocolos/:id', authMiddleware, usuariosAdmin.getUsuariosProtocolos);
...
router.post('/api/admin/usuarios/protocolos/:id', authMiddleware, usuariosAdmin.associateUsuariosProtocolos);
